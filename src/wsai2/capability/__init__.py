...
Nesta unidade foram implementadas as **definições de capacidade** e o
**registo**; a avaliação, a compatibilidade e as capacidades
disponíveis fazem parte das unidades seguintes da Fase 4.
"""
