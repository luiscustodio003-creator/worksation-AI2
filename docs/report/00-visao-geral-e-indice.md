...
| `13-pos-kernel-...` | Pós-Kernel — Ramos A–F | Application, API, UI, Knowledge semântico, Addons, Projects | Ramo A em curso (APP-01..05 congeladas; APP-06 em implementação) |
